...
added 2026-09-23; two more added 2026-09-24 (37 sources total — see `PROVENANCE.md`).
...
| `topics/07-dump-cooling.md` | Dump-cooling concept, coolant-passage sizing method, min coolant fraction, coolant-Isp recovery, refractory-metal potential, real H-1 aspirator/duct/exhaust-heat-exchanger hardware `[H1-Man]`, real F-1 turbine-exhaust-gas film-cooled nozzle extension | `[TN-Dump]` (whole), `[Huzel]` §4.4, `[Sutton]` §8.2, `[SP-8120]`, `[H1-Man]` |
...
| `topics/10-gas-generators.md` | Hot-streak control, fuel-rich MR 0.2–1.0, UMR vs hot-core, stay time 2–10 ms, Tin 800–1200 K, Table I real GGs, materials | `[SP-8081]` (whole), `[Huzel]` §4.6, `[KBKhA]`, `[H1-Man]` |
