...
- Combustion-gas heat-transfer properties (frozen cp/mu/Pr, Tc) and coolant properties
  ...
  Table 5-5). Regenerate the tables; never hand-edit them. The performance path
  (`combustion._TABLES` -> Isp) is deliberately unchanged (open item P1 in the audit doc).
